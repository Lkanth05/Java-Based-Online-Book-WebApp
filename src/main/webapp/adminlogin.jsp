		...
		<div class="col-lg-5 m-auto">
			<div class="card mt-5 bg-dark">
				<div class="card-title text-center mt-3">
					...
					<h2 style="color: black" class="mt-1">Admin Login</h2>
				</div>
					...
					<form action="adminlogin" method="post">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text-dark"> <i
						...
						<input type="reset" value="clear" class="btn btn-success px-5">
						<a href="index.jsp" class="float-right mt-2 text-blue">Go
							Back To Home</a>
					</form>
				</div>
			</div>
