 ...
 <div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="width:100%;height:550px">
    <div class="carousel-item active">
      <img src="1.jpg" alt="Los Angeles" style="width:100%;height:550px">
    </div>
...
<div class="container">
    ...
    <div class="search_box">
            <form action="SearchResult1.jsp">
              <input type="text" list="products" value="" name="spname" placeholder=" SEARCH HERE WHICH DO YOU WANT TO BUY ... ">
           ...
           <%
            ...
            <div class="grid_1_of_4 images_1_of_4 overflow-hidden">
                <a href="cart.jsp?prodid=<%= rs.getInt("prodid")%>&qty=1">
                    <img height="200" width="200" src="1.jpg<%= rs.getString("photo")%>" alt="" /></a>
