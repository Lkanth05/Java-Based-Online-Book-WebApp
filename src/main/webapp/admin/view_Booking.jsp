...
<body>
	...
	<div class="bg-white vertical-nav" id="sidebar">
		...
		<ul class="nav flex-column bg-white">
			...
			<li class="nav-item"><a href="dashboard.jsp"
				...
				class="nav-link text-light bg-dark"><i class="fas fa-users fa-fw mr-3 text-primary"></i> 
					View User
			</a></li>
			...
			<li class="nav-item"><a href="view_Feedback.jsp"
				class="nav-link text-light bg-dark"> <i class="fas fa-comment-dots fa-fw mr-3 text-primary"></i>
					View FeedBack
			</a></li>
	...
	<div class="page-content p-4" id="content">
		...
		<div class="container card shadow m-5">
			<div class="card-body">
				<h5 class="p-2" style="border-bottom: 2px solid orange">LIST OF BOOKING OREDERS....
					</h5>
